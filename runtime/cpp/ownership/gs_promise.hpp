...
//
// This is the ownership mode version - uses unique_ptr instead of shared_ptr
// for promise state to maintain single-owner semantics.
//
// NOTE: This file is only included when cppcoro headers are available.
// The generated code conditionally includes cppcoro headers when async/await is used.
///////////////////////////////////////////////////////////////////////////////

#pragma once

// Only define if cppcoro is available (included by generated code for async functions)
