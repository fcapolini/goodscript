...
/**
 * GoodScript Error Classes
 * 
 * TypeScript-compatible error types for exception handling.
 * Provides Error, TypeError, RangeError, SyntaxError, etc.
 */
...
/**
 * Base Error class matching JavaScript/TypeScript Error
 * 
 * Usage:
 *   throw Error("Something went wrong");
 *   throw Error(String("Custom error"));
 */
