...
const EXAMPLE_NAME = "readonly-arrays";
...
describe(`Concrete Example: ${EXAMPLE_NAME}`, () => {
  ...
  describe("Compilation", () => {
    ...
    it("should compile to C++ without errors", () => {
      ...
      // Check for const reference on readonly parameter
      expect(result.cppCode).toContain('const gs::Array<double>& numbers');
      // Check for mutable reference on mutable parameter
      expect(result.cppCode).toContain('gs::Array<double>& output');
    });
  });
  ...
  describe("JavaScript Execution", () => {
    ...
    it("should produce expected JavaScript output", () => {
      ...
      expect(execution.jsOutput).toContain("Sum: 15");
      expect(execution.jsOutput).toContain("Sum: 60");
      expect(execution.jsOutput).toContain("Doubled:");
    });
  });
